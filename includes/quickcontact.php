...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['form_email'] != '' AND $_POST['form_message'] != '' ) {
        ...
        $subject = isset($subject) ? $subject : 'New Message | Website Quick Contact Form';

        $botcheck = $_POST['form_botcheck'];

        $toemail = 'robert.mvungi@cardiocare.co.tz'; // Your Email Address
        $toname = 'Dr. Robert Mvungi'; // Your Name
